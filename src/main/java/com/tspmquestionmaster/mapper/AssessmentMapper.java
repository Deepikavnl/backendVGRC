...
public class AssessmentMapper {
    ...
    public EntityAssessment toEntity(
    ...
    public AssessmentResponse toResponse(
        ...
        if(assessment.getAssessmentToken()!=null){
        ...
        if(assessment.getEntity()!=null){
            ...
            response.setRiskLevel(
                    assessment.getEntity().getRiskRating()
            );
